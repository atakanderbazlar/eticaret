...
namespace ShopApp.DataAccess.Concrete.EfCore
{
    public static class SeedDatabase
    {
        public static void Seed()
        {
            ...
            //Hiç atanmamışsa alttaki eklemeyi aktif ediyor.
        ...
        {
            new Product(){ Name="All Living Things® Banana & Honey Flavor Parakeet Crunchy Sticks", Price=2000, ImageUrl="All Living Things® Banana & Honey Flavor Parakeet Crunchy Sticks.jpg", Description="<p>güzel telefon</p>"},
